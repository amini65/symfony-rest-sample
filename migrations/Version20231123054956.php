 ...
 */
final class Version20231123054956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, car_id INT DEFAULT NULL, star_rating INT NOT NULL, review_text TEXT NOT NULL, PRIMARY KEY(id))');
